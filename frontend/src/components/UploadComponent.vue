  ...
  <div class="example-full">
        ...
        <table class="table table-hover">
          ...
          <tbody>
            ...
            <tr v-for="(file, index) in files" :key="file.id">
              ...
              <td>{{this.$formatSize(file.speed)}}</td>
    ...
    <div class="option" v-show="isOption">
      ...
      <div class="form-group">
        ...
        <small class="form-text text-muted" v-if="autoCompress > 0">More than {{this.$formatSize(autoCompress)}} files are automatically compressed</small>
